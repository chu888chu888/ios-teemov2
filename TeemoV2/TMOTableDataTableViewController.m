//
//  TMOTableDataTableViewController.m
//  TeemoV2
//
//  Created by 崔 明辉 on 14-7-6.
...
@implementation TMOTableDataTableViewController
...
- (void)setupFirstLoad {
    ...
    [self.tableView firstLoadWithBlock:^(TMOTableView *tableView, TMOTableDataTableViewController *viewController) {
...
- (void)setupRefreshControl {
    [self.tableView refreshWithCallback:^(TMOTableView *tableView, TMOTableDataTableViewController *viewController) {
...
- (void)setupLoadMore {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(60.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [self.tableView.myLoadMoreControl setLoadMoreCallback:^(TMOTableView *tableView, TMOTableDataTableViewController *viewController) {
            dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
